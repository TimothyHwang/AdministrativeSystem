...
Partial Class Source_00_MOA00062
    ...
    Protected Sub btnImgIns_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnImgIns.Click
        ...
        For i = 0 To empList.Items.Count - 1
            If empList.Items(i).Selected = True Then
                ...
                Dim strPer As New SqlCommand("SELECT object_num FROM SYSTEMOBJUSE WHERE object_uid = '" & DropDownList1.SelectedValue & "' AND employee_id = '" & empList.Items(i).Value & "'", db)
                ...
                If EmpFlag = "" Then
                    ...
                    '新增關卡人員資料
                    db.Open()
                    Dim insCom As New SqlCommand("INSERT INTO SYSTEMOBJUSE(object_uid,employee_id) VALUES ('" & DropDownList1.SelectedValue & "','" & empList.Items(i).Value & "')", db)
        ...
        Try
            ...
            Else
                ...
                If LoginCheck.LoginCheck(user_id, "MOA00061") <> "" Then
                    LoginCheck.LoginAction(Request.ServerVariables("REMOTE_ADDR"), user_id, "MOA00062.aspx")
                    Response.End()
                End If
