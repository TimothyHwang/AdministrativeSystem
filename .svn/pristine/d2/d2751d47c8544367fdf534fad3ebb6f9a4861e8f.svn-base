<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MOA00014.aspx.vb" Inherits="M_Source_00_MOA00014" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>選擇欲呈轉之上一級主管</title>
...
<body>
    <form id="form1" runat="server">    
        <table border="0" width="100%" style="Z-INDEX: 101; LEFT: 104px; TOP: 33px;">
            <tr>
            <td align="center">
                    <asp:Label ID="LabTitle" runat="server" CssClass="toptitle" Text="選擇欲呈轉之上一級主管" Width="100%"></asp:Label>
            </td>
            </tr>
        </table>
