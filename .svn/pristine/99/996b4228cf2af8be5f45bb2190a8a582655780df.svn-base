...
Partial Class OA_System_OrgLeft
    ...
    Function AddNodes(ByRef tNode As TreeNode, ByVal PId As String) As String
        ...
        Try
            ...
            '選取的組織代號
            Org_Check = (Request.QueryString("Sel_Org"))

            '找出上一級全部單位
            Dim GetUpOrg As New C_Public
            Dim strGetUpOrg As String = GetUpOrg.GetUpOrgAll(Org_Check)
            ...
            If rows.GetUpperBound(0) >= 0 Then
                ...
                For Each row In rows
                    ...
                    If strGetUpOrg.IndexOf(tmpNodeId) < 0 Then
