<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MOA11002.aspx.vb" Inherits="M_Source_11_MOA11002" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>資訊設備維修申請查詢</title>
    <style type="text/css">
        .toptitle
        {
...
.titleIcon {
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            $("#txtAPPSDate").datepick({ formats: 'yyyy/m/d', defaultDate: $("#txtAPPSDate").val(), showTrigger: '#calImg' });
            $("#txtAPPEDate").datepick({ formats: 'yyyy/m/d', defaultDate: $("#txtAPPEDate").val(), showTrigger: '#calImg' });
            $("#txtFixedSDate").datepick({ formats: 'yyyy/m/d', defaultDate: $("#txtFixedSDate").val(), showTrigger: '#calImg' });
            $("#txtFixedEDate").datepick({ formats: 'yyyy/m/d', defaultDate: $("#txtFixedEDate").val(), showTrigger: '#calImg' });
            $("#txtCallSDate").datepick({ formats: 'yyyy/m/d', defaultDate: $("#txtCallSDate").val(), showTrigger: '#calImg' });
            $("#txtCallEDate").datepick({ formats: 'yyyy/m/d', defaultDate: $("#txtCallEDate").val(), showTrigger: '#calImg' });
            $("#txtARRSDate").datepick({ formats: 'yyyy/m/d', defaultDate: $("#txtARRSDate").val(), showTrigger: '#calImg' });
            $("#txtARREDate").datepick({ formats: 'yyyy/m/d', defaultDate: $("#txtARREDate").val(), showTrigger: '#calImg' });
...
<body>
        ...
        <tr>
            ...
            <td nowrap class="style4">
                <asp:DropDownList ID="ddlStatusSel" runat="server">
                    ...
                    <asp:ListItem Value=" ">處理中</asp:ListItem>
                    <asp:ListItem Value="E">處理完成</asp:ListItem>
                </asp:DropDownList>
            </td>
            <td nowrap class="style1">
    ...
    <asp:GridView ID="gvList" runat="server" Width="100%" EmptyDataText="查無任何資料" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="維修進度" SortExpression="FIXSTATUS">
                <ItemTemplate>
                    <asp:Label ID="lblFixStatus" runat="server"></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
