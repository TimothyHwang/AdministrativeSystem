...
<head runat="server">
    ...
    <script type="text/javascript"> 
        ...
        function openwin() {
            window.open('MOA10006.aspx', 'mywindow', 'fullscreen=1,toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=auto,resizable=0');
            //window.open('MOA10006.aspx', "", "fullscreen,scrollbars");
            //window.open('MOA10006.aspx', '_blank',config='height=screen.height,width=screen.width');
        }    
...
<body>
    <form id="form1" runat="server">
                            ...
                            <asp:TemplateField HeaderText="排序" SortExpression="RankId">
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton ID="imbUpArrow" runat="server" 
                                        ImageUrl="~/Image/downArrow.png" CommandName="ChangeSort" 
                                        CommandArgument='<%# Eval("RankId") %>' ToolTip="Down" />
                                    <asp:ImageButton ID="ImageButton2" runat="server" 
                                        ImageUrl="~/Image/upArrow.png" CommandArgument='<%# Eval("RankId") %>'
        ...
        <asp:Button ID="Button1" runat="server" Text="主官在營表" 
